...
class Cryptography(Frame):
    ...
    def initUI_hashFrame(self):
        ...
        self.hashCalculateLabel = Label(self, text="Calculate hash", font=("Trebuchet MS", 10))
        ...
        self.calculateHashButton = Button(self, text="Calculate hash", command=self.calculateHashes)
        ...
        self.compareHashTitle = Label(self, text="Compare hashes", font=("Trebuchet MS", 10))
